...
def page_image_study_body():
    ...
    st.info(
        ...
        f"differentiates a healthy cherry leaf from a cherry leaf infested with powdery mildew.")
    ...
    if st.checkbox("Differences between average leaf with powdery mildew and average healthy leaf"):
